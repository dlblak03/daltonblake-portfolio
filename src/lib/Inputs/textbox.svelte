...
<div class="textbox">
	<input style="background: {background};" type="text" id="{id}" name="{name}" placeholder="{placeholder}" disabled={disabled} required={required} bind:value={value} on:change on:keyup on:focus/>
