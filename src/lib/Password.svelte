...
<div class="textbox">
	<input style="background: {dark ? 'rgb(60,60,60)' : 'white'}; border-color: {dark ? 'var(--primary)' : 'var(--primary)'}; color: {dark ? 'var(--darktext)' : 'initial'};" type="password" id="{id}" name="{name}" placeholder="{placeholder}" required={required} bind:value={value} />
